...
public class Perc {
    ...
    private static double errorTreshhold = 0;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < iterations; i++) {
            ...
            double presition = checkPerceptrone(testList);
            System.out.println("pressicion is " + presition);
        }
        if (userList.size()>0){
            double presition1 = checkPerceptrone(userList);
            System.out.println("Precision on user list is" + presition1);
        }

    }

    private static double checkPerceptrone(List<Flower> list) {
